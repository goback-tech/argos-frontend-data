...
<form name="ctrl.prefsForm" class="section gf-form-group">
  <h3 class="page-heading">설정</h3>

  <div class="gf-form">
    <span class="gf-form-label width-11">UI 테마</span>
  ...
  <div class="gf-form">
    <label class="gf-form-label width-11">타임존</label>
    <div class="gf-form-select-wrapper max-width-20">
  ...
  <div class="gf-form-button-row">
    <button type="submit" class="btn btn-success" ng-click="ctrl.updatePrefs()">저장</button>
  </div>
</form>
`;
