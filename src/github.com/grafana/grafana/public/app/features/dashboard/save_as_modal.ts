...
<div class="modal-body">
	...
	<form name="ctrl.saveForm" class="modal-content" novalidate>
		<div class="p-t-2">
			<div class="gf-form">
				<label class="gf-form-label width-7">새 이름</label>
      ...
      <div class="gf-form">
		...
		<div class="gf-form-button-row text-center">
			<button type="submit" class="btn btn-success" ng-click="ctrl.save()" ng-disabled="!ctrl.isValidFolderSelection">저장</button>
			<a class="btn-text" ng-click="ctrl.dismiss();">취소</a>
		</div>
	</form>
</div>
`;
