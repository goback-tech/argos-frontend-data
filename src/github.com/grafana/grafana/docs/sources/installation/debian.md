...
------------ | -------------
Stable for Debian-based Linux | [x86-64](https://argos.goback.world/grafana/download?platform=linux)
Stable for Debian-based Linux | [ARM64](https://argos.goback.world/grafana/download?platform=arm)
Stable for Debian-based Linux | [ARMv7](https://argos.goback.world/grafana/download?platform=arm)
